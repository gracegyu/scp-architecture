...
> **상태: 재구성 반영 완료(2026-07-08)** — operator=`/v1/admin/*`·device-self=`/v1/*`(+`/me`)·`/v1/region/resolve` 제거·clinic GET/list 신설·`Clinic` 스키마 추가. OpenAPI redocly valid(41 ops).
>
...
| --- | :---: | :---: | :---: | :---: | :---: | --- | --- |
| **device** | ✅ | ✅ | ✅(예외·주=enroll) | ✅(lifecycle·kill) | ✗(=revoke) | heartbeat·token·enroll·config(gw1.1) | ✅ `/v1/admin/devices`(이동 완료) |
| **clinic** | ✅ | ✅ | ✅ | ✅ | ✗(canonical·비삭제) | `GET/PATCH /v1/clinics/me` · `PUT /v1/clinics/me/region` · `POST /v1/clinics/me/org-bindings` | ✅ op `/v1/admin/clinics`(list/read/create/update)·device-self `/me` 분리 완료 |
| **upstream** | ✅ | (list) | ✅ upsert | ✅ upsert | ✅ | — | ✅ `/v1/admin/upstreams` |
...
| **webhook_event** | ✅ search | (search) | — | — | — | — | ✅ read-only(`/v1/admin/webhook-events`) |
| **fleet_state** | ✅ | — | — | — | — | `POST /v1/fleet/heartbeat`(device push) | ✅ read-only(`/v1/admin/fleet`) |
