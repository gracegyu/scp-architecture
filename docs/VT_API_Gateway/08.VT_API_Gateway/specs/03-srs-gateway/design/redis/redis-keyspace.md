...
| --- | --- | --- | --- | --- |
| `gw:cache:clinic-region:{clinicId}` | string/hash | 초~분 | clinic→region 해석(§7.3.1) | `clinic_region_mapping` |
| `gw:cache:device-region:{deviceId}` | string/hash | 초~분 | device→region 해석 | `region_mapping` |
