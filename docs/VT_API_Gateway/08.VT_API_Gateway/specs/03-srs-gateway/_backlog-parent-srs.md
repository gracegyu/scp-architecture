...
## 참조 — 별도로 추적 중인 부모 반영 배치 (여기서 중복 기재하지 않음)
- **Console → 부모 계약 변경** — 상세는 **Console SRS(`03c-subsrs-gw-console/SRS.md`) Appendix B "부모 SRS 반영 대상"**(C-8·C-11·C-12·C-14·C-15·C-16). Console SRS baseline 후 반영.
