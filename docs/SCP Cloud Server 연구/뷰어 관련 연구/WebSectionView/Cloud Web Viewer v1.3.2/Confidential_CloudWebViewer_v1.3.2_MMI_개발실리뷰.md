...
판단 열은 "구현 가능성 · 구현 공수(하/중/상) · 추가 PoC" 순서로 표기한다. (예: "가능·하·불필요" = 구현 가능 / 공수 낮음 / 추가 PoC 불필요)
...
| 1.8 | Active section line 각도 변경(±45°) | Center line 끝 control point 드래그로 회전 | PoC에 없음(신규) | "동작 상이"가 아닌 PoC 미보유 신규 항목이라 상세는 4.5·6장(3번)에서 다룸 |
