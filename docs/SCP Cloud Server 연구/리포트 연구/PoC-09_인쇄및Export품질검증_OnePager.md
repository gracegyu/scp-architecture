...
**Project Description**: 웹 기반 SCP Cloud Report에서 생성되는 PDF 출력물과 인쇄 결과물이 의료 진단 목적에 적합한 품질을 보장하는지 검증합니다. 기존 Desktop 제품의 DICOM Print 및 고해상도 출력 품질과 동등한 수준을 웹에서 구현할 수 있는지 확인하고, 브라우저별 인쇄 일관성을 보장하는 방안을 마련합니다.
